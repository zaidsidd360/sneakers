...
This is a solution to the [E-commerce product page challenge on Frontend Mentor](https://www.frontendmentor.io/challenges/ecommerce-product-page-UPsZ9MJp6). I won't be submitting this to FE mentor as I believe my design has deviated a little too much from the given design (in a good way). You're gonna need Chrome (or Firefox) for the smoothest 3D experience. I tried my best at optimizing the models but still for some reason there are somewhat noticable frame drops in Brave and Edge. Oh and this should be obvious but you need a stable internet connection for the initial model loading.
